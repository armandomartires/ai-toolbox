...
**Six items are open, and they are not open in the same sense** — a
distinction this paragraph used to lose, because it counted three while
B-024…B-026 sat `ready` in the table above it.

- **Unscheduled and unclaimed: B-018** (raised 2026-09-16 by REVIEW-0008),
  **B-023** (raised 2026-09-23 by TASK-0051) and **B-027** (raised
  2026-09-23 by TASK-0071). These are what a planner picks from.
