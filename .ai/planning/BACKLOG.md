...
| B-032 | The Claude Code binding does not check a closed commit's file list | medium | medium | none | low | **ready** | Raised 2026-09-24 by `REVIEW-0012`. `TASK-0097` added the check to the OpenCode driver; the Claude Code template's `verifyHead()` reads HEAD, parent, porcelain and message only |
...
**Three items are open** (`B-029`…`B-031`, `B-033`, `B-034` closed 2026-09-25 by `TASK-0098`…`TASK-0102`; `B-035` raised by `TASK-0101`). Six — `B-029`…`B-034` — were raised 2026-09-24 by
