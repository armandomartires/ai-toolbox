...
queued tasks `TASK-0093`, `TASK-0094`; `TASK-0095` (read, never glob); `TASK-0096` (preflight evidence); `TASK-0097` (commit-paths check); the post-review backlog pass, `TASK-0098`… (one per item, `B-029`…`B-034`). **Next free id: `TASK-0102`.**
