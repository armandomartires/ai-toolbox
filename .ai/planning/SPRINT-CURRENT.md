...
| TASK-0040 (addendum) | TASK-0037 | **planned** | Now also owes a decision on `worktree-only`: emit Claude Code's `isolation: worktree` (an isolated *copy*) or refuse the client. **All four existing roles declare this term** |
